...
class SDKTest extends TestCase
{
  ...
  protected $languages = [
    ...
    'go' => [
      ...
      'build' => [
        'cp tests/languages/go/test.go tests/sdks/go/test.go',
        'docker run --rm -v $(pwd):/app -w /app/tests/sdks/go golang:1.16.4 go run test.go', //  npm list --depth 0 &&
        /* 'docker run --rm -v $(pwd):/app -w /app/tests/sdks/go node:14.5-alpine ls node_modules/.bin', */
        /* 'docker run --rm -v $(pwd):/app -w /app/tests/sdks/go node:14.5-alpine node_modules/.bin/tsc --lib ES6,DOM tests', */
      ],
      'supportException' => false,
    ],
  ];
